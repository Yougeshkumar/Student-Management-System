        ...
        do
            ...
            do
                ...
                then
                    ...
                    grade_return $en_attendance $en_quiz $en_mid $en_final
                    local grade=$grade_show
...
do
    ...
    case "$user_type" in
        1)
            ...
            read admin_password
            if [ "$admin_password" = "gehu@123" ]; then
